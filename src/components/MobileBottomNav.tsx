      ...
      <div className="flex items-center justify-between w-full">
        ...
        {currentRole === "client" ? (
          ...
          <button
            ...
            className="flex flex-col items-center justify-center py-1 px-0.5 rounded-xl text-purple-400 hover:text-purple-300 transition-all cursor-pointer flex-1 min-w-0"
          >
            <ShieldCheck className="w-4 h-4 mb-0.5" />
            <span className="text-[8.5px] truncate max-w-full leading-none">Tech</span>
          </button>
        )}
        ...
        {currentRole === "client" && onOpenAccount && (
          <button
            ...
            className="flex flex-col items-center justify-center py-1 px-0.5 rounded-xl text-slate-400 hover:text-white transition-all cursor-pointer flex-1 min-w-0"
          >
            <User className="w-4 h-4 mb-0.5" />
            <span className="text-[8.5px] truncate max-w-full leading-none">{t(currentLanguage, "account")}</span>
          </button>
        )}
      </div>
    </div>
