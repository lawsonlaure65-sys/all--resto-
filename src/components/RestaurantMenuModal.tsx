...
import { shareRestaurantOnWhatsApp, shareDishOnWhatsApp } from "../utils/whatsappNotifications";
        ...
        >
          ...
          <div className="relative h-56 sm:h-64 w-full bg-slate-950 shrink-0">
            ...
            <div className="absolute top-4 right-4 flex items-center gap-2">
              <button
                type="button"
                onClick={() => shareRestaurantOnWhatsApp(restaurant)}
                className="px-3 py-2 rounded-full bg-emerald-600/90 hover:bg-emerald-500 text-white font-black text-xs flex items-center gap-1.5 shadow-lg border border-emerald-400/40 cursor-pointer transition-transform active:scale-95"
                    ...
                    <div className="pt-2 flex items-center justify-between gap-1.5">
                      ...
                      <div className="flex items-center gap-1.5">
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            shareDishOnWhatsApp(item, restaurant.name);
                          }}
                          className="p-1.5 rounded-xl bg-emerald-600/20 hover:bg-emerald-600 text-emerald-400 hover:text-white border border-emerald-500/30 text-xs font-bold flex items-center justify-center transition-colors cursor-pointer"
      ...
      {selectedItemForConfig && (
        <div className="fixed inset-0 z-60 flex items-center justify-center p-4 bg-slate-950/90 backdrop-blur-md">
          ...
          >
            ...
            {/* Actions: Add to cart & WhatsApp Share */}
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={handleConfirmAddToCart}
                className="flex-1 py-3.5 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-500 text-slate-950 font-black text-sm flex items-center justify-center gap-2 hover:opacity-95 shadow-lg shadow-orange-500/20 cursor-pointer"
              >
              ...
              <button
                type="button"
                onClick={() => {
                  if (selectedItemForConfig) {
                    shareDishOnWhatsApp(selectedItemForConfig, restaurant.name);
                  }
                }}
                className="p-3.5 rounded-2xl bg-emerald-600/20 hover:bg-emerald-600 text-emerald-400 hover:text-white border border-emerald-500/40 transition cursor-pointer flex items-center justify-center gap-1.5 text-xs font-bold shrink-0 shadow-sm"
                title="Partager ce plat sur WhatsApp"
              >
