...
export const FlashMidiBanner: React.FC<FlashMidiBannerProps> = ({
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-orange-600 via-amber-600 to-emerald-800 p-4 sm:p-6 text-white shadow-xl shadow-orange-950/30 border border-orange-400/30 mb-8 max-w-full"
    >
      {/* Background patterns */}
      <div className="absolute top-0 right-0 -mt-8 -mr-8 w-48 h-48 rounded-full bg-white/10 blur-2xl pointer-events-none animate-pulse" />
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 w-full">
        <div className="space-y-1.5 text-center md:text-left min-w-0">
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
            ...
            <span className="px-2.5 py-0.5 rounded-full bg-white/20 text-white text-[10px] font-bold flex items-center gap-1.5 font-mono">
